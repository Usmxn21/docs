...
<Tip>
  **Using Chargebee, Recurly, Stripe Billing, Braintree, or Shopify (ReCharge)?** Skip the API entirely — use a [zero-code connector](/guides/connectors) and paste one webhook URL into your billing platform.
</Tip>
